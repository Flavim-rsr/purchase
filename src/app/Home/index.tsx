...
export default function Home() {
  ...
  function syncItemsByStatus(allItems: ItemStorage[], currentFilter: FilterStatus) {
    setItems(allItems.filter((item) => item.status === currentFilter));
  }
  ...
  async function handleAdd() {
    ...
    syncItemsByStatus(updatedItems, filter);
